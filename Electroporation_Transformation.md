...
A time constant between 4–6 ms is generally acceptable.
...
2. **Load cells into cuvette**
   - Add 40–50 µL of electrocompetent cells into an ice-cold electroporation cuvette.
   - Make sure the cell suspension settles at the bottom of the gap.

3. **Add plasmid DNA**
   - Add 1–2 µL of plasmid DNA directly into the cells at the bottom of the gap.
   - If you want to maximize transformation efficiency and are not volume-limited, up to 5 µL can be used.
   - Avoid introducing excess salts (use clean, low-salt DNA prep).

4. **Mix and chill**
   - Gently tap the side of the cuvette to mix cells and DNA.
